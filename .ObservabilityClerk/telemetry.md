...
| 2025-05-14 | `src/utils/github-releases.ts` | `github_releases_cache_parse_error`, `github_releases_cache_write_error`                                                              |
| 2025-05-14 | `src/components/Chat.astro`    | `chat_history_parse_error`, `chat_history_write_error`                                                                                |
