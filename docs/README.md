...
Engineering documentation for this repo. Visitor copy lives on the live site ([https://me.alehar.workers.dev/](https://me.alehar.workers.dev/)). The [GitHub Wiki](https://github.com/alehar9320/astro-cloudflare-personal-website/wiki) is a map only ([UX writing bar](https://github.com/alehar9320/astro-cloudflare-personal-website/wiki/UX-Writing)); it is not a second source of truth.
...
| [inspirations.md](inspirations.md) | Reference personal sites for design and structure (taste, not queue) |
...
- Production host: Cloudflare Workers only ([ADR 0001](adr/0001-cloudflare-production-render-jules.md)).
- GitHub Pages stays off.
- Product work stays on [issue #617](https://github.com/alehar9320/astro-cloudflare-personal-website/issues/617); do not invent a parallel eng queue here.
