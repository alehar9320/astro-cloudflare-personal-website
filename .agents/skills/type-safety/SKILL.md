...
3. **Automated Type Generation:** For environment bindings, always run `npx wrangler types` to generate accurate types. The agent must assume a TypeScript-first environment where all Cloudflare bindings are explicitly typed.
