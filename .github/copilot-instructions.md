...
- Release source of truth: GitHub releases/tags are the canonical version and changelog source. The footer version link and `/whats-new` route depend on GitHub release data rather than tracked generated files.
...
- scripts/release.js — generates GitHub release metadata for the CI release job
