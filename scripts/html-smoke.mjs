...
/**
 * What's New, This site, Roadmap, and Site success share the Skip to content gate (#1123).
 * @param {string} relativePath
 */
function isVisitorContentPage(relativePath) {
  const routes = ['whats-new', 'this-site', 'roadmap', 'okr'];
  return routes.some(
    (route) =>
...
/**
 * Gate: home, 404, What's New, This site, Roadmap, Site success. Experimental stubs stay unchecked.
