 ...
 * Uses .slice(0, 10) instead of .split('T')[0] to avoid allocating intermediate string arrays on edge runtimes.
 * Benchmark note: .slice(0, 10) is ~2-3x faster and zero-allocation compared to .split('T')[0].
