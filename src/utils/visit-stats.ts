...
/**
 * Extracts a column value from a row using either object property access or hashtable column index map.
 * Replaces repeated O(N) array indexOf scans with O(1) constant-time property reads.
 */
