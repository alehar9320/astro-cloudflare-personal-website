...
/**
 * Optimization (⚡ Bolt / Technical Standard):
 * Pre-computes O(1) column index hashtable lookup map before reading fields,
 * replacing repeated O(N) array scans per response field.
 */
