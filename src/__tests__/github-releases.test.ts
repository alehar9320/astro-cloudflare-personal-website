  ...
  it('normalizes published releases', () => {
    expect(
      normalizeRelease({
        ...
        name: '2026.06.25.0434',
        published_at: '2026-06-25T04:34:00Z',
        tag_name: '2026.06.25.0434',
      })
    ).toEqual({
      body: '- feat: add release feed',
      publishedAt: '2026-06-25T04:34:00Z',
      title: '2026.06.25.0434',
      url: 'https://github.com/example/release',
      version: '2026.06.25.0434',
    });
  });
  ...
  it('filters out invalid or draft releases', async () => {
    const fetchMock = vi.fn().mockResolvedValue({
      ...
      json: async () => [
        ...
        { body: '- feat: ship', html_url: RELEASES_PAGE_URL, tag_name: '2026.06.25.0434' },
      ],
    });
