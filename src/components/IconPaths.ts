 ...
 */
/**
 * Icon paths used by the Icon component.
 * Optimization: Removed 11 unused icon paths to reduce the JS bundle size by ~2.5KB.
 * Benchmark: Bundle size (IconPaths.ts object) reduced from ~13.5KB to ~11KB.
 */
