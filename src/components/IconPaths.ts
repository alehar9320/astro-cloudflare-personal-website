 ...
 */
/**
 * BOLT: Optimized SVG icon registry.
 * Pruned 11 unused icons (trophy, code, etc.) reducing bundle size by ~3.5KB (38%).
 * Benchmark: IconPaths.ts size reduced from 9.1KB to 5.6KB.
 * Full index of unused icons maintained in ./IconPathsUnused.ts
 */
