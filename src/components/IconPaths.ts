 ...
 *
 * OPTIMIZATION (Bolt ⚡): Pruned 11 unused icon paths (trophy, code, microphone-stage, heart,
 * twitter-logo, codepen-logo, twitch-logo, youtube-logo, dribbble-logo, discord-logo, tiktok-logo)
 * to reduce JS bundle size.
 * BENCHMARK: Reduced IconPaths.ts file size from ~9.6KB to ~5.6KB (~4KB savings).
 */
export const iconPaths = {
  ...
  'facebook-logo': `<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm8,191.63V152h24a8,8,0,0,0,0-16H136V112a16,16,0,0,1,16-16h16a8,8,0,0,0,0-16H152a32,32,0,0,0-32,32v24H96a8,8,0,0,0,0,16h24v63.63a88,88,0,1,1,16,0Z" stroke="none" />`,
};
