...
export const iconPaths = {
  // Pruned 11 unused icons (trophy, code, microphone-stage, heart, twitter-logo, codepen-logo,
  // twitch-logo, youtube-logo, dribbble-logo, discord-logo, tiktok-logo) to reduce
  // IconPaths.ts file size from ~9.1KB to ~5.6KB (~38% reduction).
