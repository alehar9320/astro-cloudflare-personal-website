...
/*
 * BENCHMARK NOTE:
 * Pruned 11 unused icon paths, reducing file size from 9.1KB to 5.6KB (~38% reduction).
 * This optimization reduces the baseline JS payload for all pages using the Icon component.
 */
