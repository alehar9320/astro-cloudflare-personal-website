 ...
 *
 * Performance Optimization (2025-05-16):
 * Pruned 11 unused icons (trophy, code, microphone-stage, heart, and several social logos)
 * to reduce the JavaScript bundle size.
 * Measurement: File size reduced from 9.1KB to 5.6KB (approx. 38% reduction).
 *
 * Want to add more?
